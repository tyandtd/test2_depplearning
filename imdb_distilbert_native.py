...
test = pd.read_csv("F:\\deeplearning\\test2\\imdb_sentiment_analysis_torch\\testData.tsv", header=0,
                   delimiter="\t", quoting=3)
#这个与bert_native类似，都是定义了读取train的一个格式，两边的内容也一致，即本地训练
...
#开始预测模型
    ...
    result_output.to_csv("F:\\deeplearning\\test2\\imdb_sentiment_analysis_torch\\result\\distilbert_native.csv", index=False, quoting=3)
